...
python train_ppo.py --RL_config MAPPO_episode500_epoch20_beta1e-1_seed1234 --task 1
...
# python train_mappo.py --RL_config MASAC_episode500_epoch20_beta1e-1_seed666