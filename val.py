...
from predictors.autoval import AntoCloestQCNet
...
if __name__ == '__main__':
    ...
    # wandb.init(project='QCNet', entity='guanrenqiao')
    # wandb.finish()
    
    for episode in range(args.episodes):
        global current_episode
        current_episode = episode
        trainer = pl.Trainer(accelerator=args.accelerator, devices=args.devices, strategy='ddp',limit_val_batches=50)
